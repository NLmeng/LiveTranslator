...
from screen.controller import (blur_background, capture_screenshot,
...
class TestController(unittest.TestCase):
    ...
    def test_put_text_on_frame(self, mock_GaussianBlur, mock_getTextSize, mock_rectangle, mock_putText):
        ...
        mock_rectangle.assert_called_once_with(
            mock_frame, (10, 10), (20, 20), (0, 255, 0), 2)
        mock_putText.assert_called_once_with(
            mock_frame, 'Test', (10, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 0, 0), 1, cv2.LINE_AA)
